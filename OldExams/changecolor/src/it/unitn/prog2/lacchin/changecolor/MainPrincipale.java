...
public class MainPrincipale extends Application implements EventHandler <ActionEvent>{
    int index = 0;
    boolean right = true;
    ...
    public void start(Stage primaryStage) {
        ...
        change.setId("change");
        turn.addEventHandler(ActionEvent.ACTION,this);
        turn.setId("turn");
        ////////////////////////////////////////
