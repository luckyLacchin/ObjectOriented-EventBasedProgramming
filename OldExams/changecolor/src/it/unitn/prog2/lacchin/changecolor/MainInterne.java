...
public class MainInterne extends Application {
    int index = 0;
    boolean right = true;
    ...
    public void start(Stage primaryStage) {
        ...
        change.addEventHandler(ActionEvent.ACTION,new changeListener());
        turn.addEventHandler(ActionEvent.ACTION,new turnListener());
        ////////////////////////////////////////
    ...
    class changeListener implements EventHandler <ActionEvent> {
    ...
    class turnListener implements EventHandler <ActionEvent> {
