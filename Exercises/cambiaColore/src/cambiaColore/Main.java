...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        /*direzione.setOnAction(new EventHandler<ActionEvent>() {
            @Override
         ...
         */
        cambia.addEventHandler(ActionEvent.ACTION,new CambiaListener());
        /*cambia.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent event) {
                if (verse){
                    index++;
         ...
         */
        direzione.setOnAction(new DirezioneListener());
    ...
    public class CambiaListener implements EventHandler <ActionEvent> { //questo listener può prendere solo eventi di tipo ACTION
